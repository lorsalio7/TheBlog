const project_destination = "dist";
const development_folder = "app";
...
const path = {
  ...
  src: {
    ...
    forWebp: development_folder + "/img/*.{jpg,png,jpeg}",
...
// function avifWebp() {
//   return src(path.src.forWebp)
//   .pipe(newer(path.build.img))
//   .pipe(avif({quality: 40}))
//   // .pipe(dest(path.build.img))
//   // .pipe(newer(path.build.img))
//   .pipe(src(path.src.forWebp))
...
const build = gulp.series(clean, gulp.parallel(gulpPug, js, css, html, images, cssLibs, jsLibs));
const watch = gulp.parallel(build, watchFiles ,browserSync);

exports.pug = gulpPug;
exports.fonts = fonts;
exports.images = images;
// exports.avif = avifWebp;
